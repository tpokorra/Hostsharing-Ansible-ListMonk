Hostsharing-Ansible-ListMonk
============================

This Ansible playbook will install the latest [ListMonk](https://listmonk.app/) release on a server from www.hostsharing.net.
...
We clone this git-repo to our machine:
    ...
    $ git clone https://github.com/tpokorra/Hostsharing-Ansible-ListMonk.git

Then we change the working directory:

    $ cd Hostsharing-Ansible-ListMonk
